                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (ctx, index) => Column(
                      children: <Widget>[
                        ListTile(
                          leading: Image.asset(
                            'lib/external-libs/intl_phone_field-2.0.0/assets/flags/${filteredCountries[index]['code']!.toLowerCase()}.png',
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Image.asset(
                'lib/external-libs/intl_phone_field-2.0.0/assets/flags/${_selectedCountry['code']!.toLowerCase()}.png',
                //package: 'intl_phone_field',
                width: 32,
              ),
              SizedBox(width: 8),
