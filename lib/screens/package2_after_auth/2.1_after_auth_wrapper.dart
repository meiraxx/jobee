...
import 'package:jobee/screens/package2_after_auth/2.2_user_resource_loader.dart' show UserResourceLoader;
import 'package:jobee/screens/package3_user_details_registration/3.2_submit_personal_profile_data.dart' show SubmitPersonalProfileData;
import 'package:jobee/screens/package3_user_details_registration/3.1_submit_public_profile_data.dart' show SubmitPublicProfileData;
...
class _AfterAuthWrapperState extends State<AfterAuthWrapper> {
  ...
  Widget build(BuildContext context) {
    ...
    if (appUserData.hasRegisteredPublicData == false) return const SubmitPublicProfileData();
    // else, if we haven't submitted personal data yet, head to the SubmitPersonalProfileData() widget
    if (appUserData.hasRegisteredPersonalData == false) return const SubmitPersonalProfileData();
