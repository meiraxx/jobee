...
///  * [CustomCheckedPopupMenuItem], a popup menu item with a checkmark.
...
/// complete menu, and see the example at [CustomCheckedPopupMenuItem] for one way to
/// keep the text of [CustomPopupMenuItem]s that use [Text] widgets in their [child]
/// slot aligned with the text of [CustomCheckedPopupMenuItem]s or of [CustomPopupMenuItem]
/// that use a [ListTile] in their [child] slot.
///
/// See also:
///
///  * [CustomPopupMenuDivider], which can be used to divide items from each other.
///  * [CustomCheckedPopupMenuItem], a variant of [CustomPopupMenuItem] with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [CustomPopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
...
/// shows a popup menu, consider using [CustomPopupMenuButton].
///
/// A [CustomCheckedPopupMenuItem] is kMinInteractiveDimension pixels high, which
...
///  * [CustomPopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
class CustomCheckedPopupMenuItem<T> extends CustomPopupMenuItem<T> {
...
class _CheckedPopupMenuItemState<T> extends PopupMenuItemState<T, CustomCheckedPopupMenuItem<T>> with SingleTickerProviderStateMixin {
...
/// dismissed.
///
/// Used by [CustomPopupMenuButton.onSelected].
typedef PopupMenuItemSelected<T> = void Function(T value);

/// Signature for the callback invoked when a [CustomPopupMenuButton] is dismissed
/// without selecting an item.
///
/// Used by [CustomPopupMenuButton.onCanceled].
typedef PopupMenuCanceled = void Function();

/// Signature used by [CustomPopupMenuButton] to lazily construct the items shown when
...
/// then [CustomPopupMenuButton] behaves like an [IconButton].
///
